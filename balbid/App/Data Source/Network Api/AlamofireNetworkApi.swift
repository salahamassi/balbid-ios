...
final class AlamofireNetworkApi: NetworkApi {
    ...
    func request(url: String, method: String, params: [String: Any?], files: [String: URL]?, headers: [String: String], completion: DataSourceCompletion?) {
        ...
        if let files = files{
            ...
            let request = AF.request(url, method: httpMethod, parameters: method == .post ? params as Parameters : nil, encoding: encoding, headers: alamofireHeaders, interceptor: nil, requestModifier: nil)
